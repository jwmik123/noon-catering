...
const EMAIL_CONSTANTS = {
  ...
  ADMIN_EMAIL: ["bestel@noonsandwicherie.be", "verkoop-0795406037@abpart.clouddemat.be"],
  EMAIL_SUBJECTS: {
    ...
    <html>
      ...
      <body>
        <div class="container">
          <!-- Logo -->
          <div class="logo">
            <img src="https://catering.thesandwichbar.nl/tsb-logo-full.png" alt="NOON Sandwicherie & Koffie Logo" />
          </div>
