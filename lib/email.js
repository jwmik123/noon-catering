      ...
      <body>
        <div class="container">
                  ...
                  orderDetails.selectionType === "custom"
                    ...
                    : `
                      <tr>
                        ...
                        <td>-</td>
                        <td>-</td>
                        <td>€${((orderDetails.varietySelection?.nonVega || 0) * (pricing?.categoryPricing?.find(cat => cat.typeCategory === 'sandwiches')?.subCategoryPricing?.[0]?.price || 0)).toFixed(2)}</td>
                      </tr>
                      <tr>
                        <td>Vegetarian</td>
                        ...
                        <td>-</td>
                        <td>-</td>
                        <td>€${((orderDetails.varietySelection?.vega || 0) * (pricing?.categoryPricing?.find(cat => cat.typeCategory === 'sandwiches')?.subCategoryPricing?.find(sc => sc.subCategory === 'veggie')?.price || 0)).toFixed(2)}</td>
                      </tr>
                      <tr>
                        <td>Vegan</td>
                        ...
                        <td>-</td>
                        <td>-</td>
                        <td>€${((orderDetails.varietySelection?.vegan || 0) * (pricing?.categoryPricing?.find(cat => cat.typeCategory === 'sandwiches')?.subCategoryPricing?.find(sc => sc.subCategory === 'vegan')?.price || 0)).toFixed(2)}</td>
                      </tr>
                      ${
                        orderDetails.deliveryCost &&
                        orderDetails.deliveryCost > 0
          ...
          <div class="price-section">
            <div class="price-row">Subtotal: €${(amountData.subtotal || 0).toFixed(2)}</div>
            ${(amountData.delivery || 0) > 0 ? `<div class="price-row">Delivery: €${(amountData.delivery || 0).toFixed(2)}</div>` : `<div class="price-row">Delivery: Free</div>`}
