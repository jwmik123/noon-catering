...
export async function sendInvoiceEmail(invoice, pricing = null) {
  ...
  try {
    ...
    // Default to delivery address when sameAsDelivery is undefined or true
    const useSameAddress = orderDetails.sameAsDelivery !== false;
    const invoiceDetails = {
      sameAsDelivery: useSameAddress,
