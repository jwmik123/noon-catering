...
export const isDrink = (product) => {
  const typeCategoryValue = product.typeCategory?.value || product.typeCategory;
  return typeCategoryValue === "desserts";
};

export const isSandwich = (product) => {
  const typeCategoryValue = product.typeCategory?.value || product.typeCategory;
  return typeCategoryValue === "sandwiches";
};
