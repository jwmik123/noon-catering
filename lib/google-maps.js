...
export const DELIVERY_PRICING = {
  RANGES: [
    { maxKm: 3, cost: 19, label: "0-3km" },      // 0-3km: €19
    { maxKm: 5, cost: 25, label: "3-5km" },     // 3-5km: €25
    { maxKm: 7, cost: 30, label: "5-7km" },   // 5-10km: €30
    { maxKm: 10, cost: 55, label: "7-10km" },   // 5-10km: €55
  ],
  FREE_DELIVERY_THRESHOLD: 500 // Free delivery for orders above €500
};
...
// Prioritizes biking distance, falls back to driving distance
